...
public class Counter extends Actor
{
    ...
    {
        target += 100*score;  //adds score to target
    }
    ...
    private void updateImage()
    {
        ...
        GreenfootImage text = new GreenfootImage(prefix + value, 16, Color.BLACK, transparent);  //initializing the text of the counter
