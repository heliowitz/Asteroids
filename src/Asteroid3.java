 ...
 * @version (June 2013)
 */
public class Asteroid3 extends Actor
{
    ...
    private int asteroidHealth = 5; //declare and initialize integer asteroidHealth at 5
   ...
   private GreenfootSound asteroidDestroy;  //declare new GreenfootSound asteroidDestroy
    ...
    public Asteroid3 (int moveToX, int moveToY)
    {
